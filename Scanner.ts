        ...
        loop: for (; ;) {
            switch (state) {
				...
				case 1:
					...
					if (this.ch >= '0'.charCodeAt(0) && this.ch <= '9'.charCodeAt(0) || this.ch >= 'A'.charCodeAt(0) && this.ch <= 'Z'.charCodeAt(0) || this.ch == '_'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'z'.charCodeAt(0)) {this.AddCh(); state = 1; break;}
				...
				case 5:
					if (this.ch <= 9 || this.ch >= 11 && this.ch <= 12 || this.ch >= 14 && this.ch <= '&'.charCodeAt(0) || this.ch >= '('.charCodeAt(0) && this.ch <= '['.charCodeAt(0) || this.ch >= ']'.charCodeAt(0) && this.ch <= 65535) {this.AddCh(); state = 6; break;}
				...
				case 7:
					if (this.ch >= ' '.charCodeAt(0) && this.ch <= '~'.charCodeAt(0)) {this.AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					if (this.ch >= '0'.charCodeAt(0) && this.ch <= '9'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'f'.charCodeAt(0)) {this.AddCh(); state = 8; break;}
					else if (this.ch == 39) {this.AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
					{this.t.kind = 5; break loop;}
				case 10:
					recEnd = this.pos; recKind = 45;
					if (this.ch >= '0'.charCodeAt(0) && this.ch <= '9'.charCodeAt(0) || this.ch >= 'A'.charCodeAt(0) && this.ch <= 'Z'.charCodeAt(0) || this.ch == '_'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'z'.charCodeAt(0)) {this.AddCh(); state = 10; break;}
					else {this.t.kind = 45; break loop;}
				case 11:
					recEnd = this.pos; recKind = 46;
					if (this.ch >= '-'.charCodeAt(0) && this.ch <= '.'.charCodeAt(0) || this.ch >= '0'.charCodeAt(0) && this.ch <= ':'.charCodeAt(0) || this.ch >= 'A'.charCodeAt(0) && this.ch <= 'Z'.charCodeAt(0) || this.ch == '_'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'z'.charCodeAt(0)) {this.AddCh(); state = 11; break;}
					else {this.t.kind = 46; break loop;}
				case 12:
					if (this.ch <= 9 || this.ch >= 11 && this.ch <= 12 || this.ch >= 14 && this.ch <= '!'.charCodeAt(0) || this.ch >= '#'.charCodeAt(0) && this.ch <= '['.charCodeAt(0) || this.ch >= ']'.charCodeAt(0) && this.ch <= 65535) {this.AddCh(); state = 12; break;}
					else if (this.ch == 10 || this.ch == 13) {this.AddCh(); state = 4; break;}
					else if (this.ch == '"'.charCodeAt(0)) {this.AddCh(); state = 3; break;}
					else if (this.ch == 92) {this.AddCh(); state = 14; break;}
					else {state = 0; break;}
				case 13:
					recEnd = this.pos; recKind = 45;
					if (this.ch >= '0'.charCodeAt(0) && this.ch <= '9'.charCodeAt(0)) {this.AddCh(); state = 10; break;}
					else if (this.ch >= 'A'.charCodeAt(0) && this.ch <= 'Z'.charCodeAt(0) || this.ch == '_'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'z'.charCodeAt(0)) {this.AddCh(); state = 15; break;}
					else {this.t.kind = 45; break loop;}
				case 14:
					if (this.ch >= ' '.charCodeAt(0) && this.ch <= '~'.charCodeAt(0)) {this.AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 15:
					recEnd = this.pos; recKind = 45;
					if (this.ch >= '0'.charCodeAt(0) && this.ch <= '9'.charCodeAt(0)) {this.AddCh(); state = 10; break;}
					else if (this.ch >= 'A'.charCodeAt(0) && this.ch <= 'Z'.charCodeAt(0) || this.ch == '_'.charCodeAt(0) || this.ch >= 'a'.charCodeAt(0) && this.ch <= 'z'.charCodeAt(0)) {this.AddCh(); state = 15; break;}
					else if (this.ch == '='.charCodeAt(0)) {this.AddCh(); state = 11; break;}
					else {this.t.kind = 45; break loop;}
				case 16:
					{this.t.kind = 17; break loop;}
				case 17:
					{this.t.kind = 20; break loop;}
				case 18:
					{this.t.kind = 21; break loop;}
				case 19:
					{this.t.kind = 22; break loop;}
				case 20:
				...
				case 23:
					{this.t.kind = 29; break loop;}
				case 24:
					{this.t.kind = 30; break loop;}
				case 25:
					{this.t.kind = 31; break loop;}
				case 26:
				...
				case 33:
					...
					if (this.ch == '.'.charCodeAt(0)) {this.AddCh(); state = 19; break;}
					else if (this.ch == '>'.charCodeAt(0)) {this.AddCh(); state = 24; break;}
					else if (this.ch == ')'.charCodeAt(0)) {this.AddCh(); state = 32; break;}
					else {this.t.kind = 18; break loop;}
				case 34:
					recEnd = this.pos; recKind = 24;
					if (this.ch == '.'.charCodeAt(0)) {this.AddCh(); state = 23; break;}
					else {this.t.kind = 24; break loop;}
				case 35:
					recEnd = this.pos; recKind = 35;
					if (this.ch == '.'.charCodeAt(0)) {this.AddCh(); state = 31; break;}
					else {this.t.kind = 35; break loop;}
